                ...
                @foreach ($query as $row)
                    <tr class=" text-slate-900 hover:bg-slate-200">
                        ...
                        <td class="flex justify-center ">
                            <a class="mr-2 mt-2 p-1 bg-[#fb8500] rounded-lg items-center" href=""><svg
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#fff" class="w-5 h-5">
                                    <path
                    ...
                    {{-- <div class="visible-print text-center">
                        {!! QrCode::size(100)->generate($row->qr_code) !!}
                    </div> --}}
                @endforeach
            </tbody>
        </table>
