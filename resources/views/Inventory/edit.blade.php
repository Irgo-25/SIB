    ...
    <form action="{{ route('inventory.update', $row->kode_barang) }}" method="POST">
        ...
        <div class="mb-6 mr-3">
            ...
            <input type="text" id="kode-barang" name="kode_barang"
                ...
                required readonly value="{{ old('kode_barang', $row->kode_barang)}}">
        </div>
        <div class="mb-6 mr-3">
            ...
            <input type="text" id="nama-barang" name="nama_barang"
                ...
                required value="{{ old('nama_barang', $row->nama_barang) }}">
        </div>
        <div class="mb-6 mr-3">
            ...
            <input type="text" id="penempatan" name="penempatan"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required value="{{ old('penempatan', $row->penempatan) }}">
        </div>
        <div class="mb-6 mr-3">
            ...
            <input type="text" id="qr-code" name="qr_code"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required value="{{ old('qr_code', $row->qr_code) }}">
        </div>
